 ...
 */
function MarkerSnap(width, height)
{
 ...
 * @return (nothing)
 */
MarkerSnap.prototype.draw = function(bufferContext, x, y)
{
    var radius = (this.snapWidth/2) - (this.snapWidth/10);
    bufferContext.beginPath();
    bufferContext.arc(x, y, radius, 0, Math.PI*2, false);
    bufferContext.closePath();
    bufferContext.strokeStyle = "#3366FF";
    bufferContext.stroke();
    bufferContext.fillStyle = "#3366FF";
    bufferContext.fill();
};